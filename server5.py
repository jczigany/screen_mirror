import socket, threading, time, pickle, cv2, struct
...
class Mainwindow(QMainWindow):
    ...
    # def handle_client(self, conn, conn_name):
    #     while True:
    ...
    def hatter_folyamat(self):
        while True:
            ...
            print('---Recieved DATA---')
            # self.screen1_label.setText(str(payload))
            ...
            self.send_data(conn, 'Image received on server')
        conn.close()
